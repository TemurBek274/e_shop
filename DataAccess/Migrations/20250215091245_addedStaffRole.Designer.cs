...
namespace DataAccess.Migrations
{
    ...
    [Migration("20250215091245_addedStaffRole")]
    partial class addedStaffRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("e_shop.Domain.Entities.AttributeDb", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("e_shop.Domain.Entities.ProductAttribute", b =>
                {
            ...
            modelBuilder.Entity("e_shop.Domain.Entities.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAp")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("created_ap");

                    b.Property<int>("CreatedBy")
                        .HasColumnType("integer")
                        .HasColumnName("created_by");

                    b.Property<string>("Privlegs")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("privlegs");
            ...
            modelBuilder.Entity("e_shop.Domain.Entities.StaffAccount", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_staf_accounts");

                    b.ToTable("staf_accounts", (string)null);
                });
            ...
            modelBuilder.Entity("e_shop.Domain.Entities.StaffRole", b =>
                {
                    ...
                    b.HasIndex("StaffId")
                        .HasDatabaseName("ix_staff_roles_staff_id");
            ...
            modelBuilder.Entity("e_shop.Domain.Entities.ProductAttribute", b =>
                {
                    b.HasOne("e_shop.Domain.Entities.AttributeDb", "AttributeDb")
            ...
            modelBuilder.Entity("e_shop.Domain.Entities.StaffRole", b =>
                {
                    ...
                    b.HasOne("e_shop.Domain.Entities.StaffAccount", "StaffAccount")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_staff_roles_staf_accounts_staff_id");
